...
#define NUMSIDES 6 //number of sides for the case holding dreamIO
...
class MotionState{
    public:
        ...
        // accessors
        int whichSide(); //checks the side the cube is on
        float sideValue(); //returns the current side's value
        bool isMotion(); //checks if cube is moving
